...
public int EmailSending(String To, String Sub, String Msg) {
            ...
            session = Session.getDefaultInstance(props,
                    new javax.mail.Authenticator() {
                        ...
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication("myproject3694@gmail.com","javaproject");
                        }
                    });
        
            String From = "kumawat.swapnil@gmail.com";
    ...
    public static void main(String[] args) {
        ...
        s.EmailSending("kumawat.swapnil@gmail.com", "Test", "Test");
