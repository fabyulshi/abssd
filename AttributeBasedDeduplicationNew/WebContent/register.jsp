				...
				<table border="0" cellpadding="5" cellspacing="5">
					<tr>
						...
						<td><input type="text" style="width: 170px; height: 30px"
							...
							name="mname" required="required" placeholder="Middle Name"/>
	<input type="text" style="width: 170px; height: 30px"
							name="lname" required="required" placeholder="Last Name"/></td>
					</tr>
					<tr>
						<td>Gender</td>
					...
					<tr>	<td>Date of Birth</td>
						<td><input type="date" style="width: 170px; height: 30px"
							name="dob" required="required"/></td></tr>
					...
					<tr>	<td>Mobile No.</td>
						<td><input type="number" id="mobno "name="mobno" pattern="((?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).{6,20})" maxlength="10" 
							style="width: 170px; height: 30px"  required="required" placeholder="Mobile"/></td>

					</tr>
					<tr>
						<td>Email ID</td>
						<td><input type="email" name="email"
							style="width: 170px; height: 30px"  required="required" placeholder="Email"/></td>
					</tr>
					<tr>	<td>Password</td>
						<td><input type="password" name="pwd" 
							style="width: 170px; height: 30px"  required="required"  placeholder="Password"/></td>
</tr>
					<tr>
					...
					<tr>
						<td>Privileges</td>
						<td>
						<input type="checkbox" name="chk" value="Student" /> Student 
						&nbsp;&nbsp;<input type="checkbox" name="chk" value="HOD" /> Technical 
						&nbsp;&nbsp;<input type="checkbox" name="chk" value="Principle"/> Non-Technical
						</td>
						<td></td>
						<td></td>
